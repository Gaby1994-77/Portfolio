...
const ContactMe = () => {
  return (
    <div className="mt-6">
    <div className="bg-gray-50 dark:bg-neutral-900 mt-12 md:mt-20 lg:mt-32" id="contact">
